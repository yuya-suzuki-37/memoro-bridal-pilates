...
const DB_PILATES = [
  ...
  // ============== 姿勢補強・追加（ストレートネック/巻き肩/足首の偏りをならす）==============
  {
    id:'pl_wall_angel', name:'ウォールエンジェル', courses:['pilates'],
    targetProblems:['roundedShoulders','thoracicKyphosis','forwardHead'],
    category:'mobility', technique:'pilates', bodyPart:'shoulder', intensity:1,
    equipment:'壁', position:'standing', duration:'10回',
    illustration: SVG2.wallAngel,
    purpose:'壁に沿って腕を上下し、丸まった背中と巻き肩をまとめてリセット。',
    how:['壁に後頭部・背中・お尻をつけて立つ。','肘を90度に曲げ、手の甲を壁につける。','腕を壁に沿ってゆっくり上下させる。'],
    cues:{do:'腰と壁のすき間を薄く保つ。',dont:'腰を反らせて浮かせない。'},
    why:'肩甲骨の上方回旋と胸椎伸展を同時に引き出し、猫背・巻き肩・頭の前傾を整える。'
  },
  {
    id:'pl_chin_tuck', name:'チンタック（顎引き）', courses:['pilates'],
    targetProblems:['forwardHead'],
    category:'selfcare', technique:'mobility', bodyPart:'neck', intensity:1,
    equipment:'なし', position:'seated', duration:'10回',
    illustration: SVG2.neckSide,
    purpose:'前に出た頭を正しい位置へ。ストレートネックの土台を整える。',
    how:['背すじを伸ばして座る。','顎を軽く引き、後頭部を上へ引き上げる（二重顎を作るように）。','5秒キープしてゆるめる。'],
    cues:{do:'耳が肩の真上に来るように。',dont:'うつむいて顎を下げない。'},
    why:'深部の頸部屈筋を活性化し、頭の前方位を後方へ再教育する。'
  },
  {
    id:'pl_neck_release', name:'ネックリリース', courses:['pilates'],
    targetProblems:['forwardHead','thoracicKyphosis'],
    category:'selfcare', technique:'stretch', bodyPart:'neck', intensity:1,
    equipment:'なし', position:'seated', duration:'左右各20秒',
    illustration: SVG2.neckTilt,
    purpose:'こわばった首すじをゆるめ、頭の位置をリセット。',
    how:['背すじを伸ばして座る。','頭を横にゆっくり倒し、首すじの伸びを感じる。','反対側も同様に。'],
    cues:{do:'肩は下げたまま。',dont:'肩を一緒に上げない。'},
    why:'後頭下筋・僧帽筋上部の緊張をゆるめ、ストレートネックの負担を軽減。'
  },
  {
    id:'pl_thread_needle', name:'スレッドザニードル', courses:['pilates'],
    targetProblems:['thoracicKyphosis','roundedShoulders','lateralAsymmetry'],
    category:'mobility', technique:'pilates', bodyPart:'spine', intensity:1,
    equipment:'マット', position:'quadruped', duration:'左右各6回',
    illustration: SVG2.threadNeedle,
    purpose:'胸まわりをねじって開き、背中と肩甲骨をしなやかに。',
    how:['四つ這いになる。','片腕を反対の脇の下に通し、肩と側頭部を床へ。','戻して天井方向へ腕を開く。'],
    cues:{do:'骨盤は水平に保つ。',dont:'腰からねじらない。'},
    why:'胸椎の回旋モビリティを高め、丸まり・巻き肩・左右差を整える。'
  },
  {
    id:'pl_chest_opener', name:'チェストオープナー', courses:['pilates'],
    targetProblems:['roundedShoulders','thoracicKyphosis','forwardHead'],
    category:'selfcare', technique:'stretch', bodyPart:'chest', intensity:1,
    equipment:'なし', position:'standing', duration:'20秒×2',
    illustration: SVG2.chestOpener,
    purpose:'縮こまった胸の前側を開き、デコルテを美しく。',
    how:['両手を体の後ろで組む。','肩甲骨を寄せて胸を前に開く。','呼吸しながらキープ。'],
    cues:{do:'胸を斜め上へ引き上げる。',dont:'腰を反らせない。'},
    why:'大胸筋・小胸筋の柔軟性を高め、巻き肩による胸の閉じを解放する。'
  },
  {
    id:'pl_ankle_circle', name:'アンクルサークル', courses:['pilates'],
    targetProblems:['ankleStiffness'],
    category:'mobility', technique:'mobility', bodyPart:'leg', intensity:1,
    equipment:'なし', position:'seated', duration:'左右各10回',
    illustration: SVG2.ankleRotation,
    purpose:'足首をなめらかに動かし、むくみと立ち姿の安定に。',
    how:['座って片脚を伸ばす。','足首を大きくゆっくり回す。','逆回しも同様に。'],
    cues:{do:'つま先で大きな円を描く。',dont:'脚全体を動かさない。'},
    why:'足関節の可動域を広げ、循環と立位バランスを高める。'
  },
  {
    id:'pl_calf_stretch', name:'カーフストレッチ', courses:['pilates'],
    targetProblems:['ankleStiffness'],
    category:'selfcare', technique:'stretch', bodyPart:'leg', intensity:1,
    equipment:'壁', position:'standing', duration:'左右各20秒',
    illustration: SVG2.calfStretch,
    purpose:'ふくらはぎを伸ばし、足首の硬さとむくみをケア。',
    how:['壁に手をつき、片脚を後ろへ引く。','後ろ脚のかかとを床につけたまま前へ体重を移す。','ふくらはぎの伸びを感じてキープ。'],
    cues:{do:'後ろ脚の膝を伸ばす。',dont:'かかとを浮かせない。'},
    why:'下腿三頭筋の柔軟性を高め、足関節の背屈と立ち姿を改善する。'
  },
];
